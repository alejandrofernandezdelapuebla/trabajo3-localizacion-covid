...
public class ContactosCovid {
	...
	private void cargaDatos(String[] datas) throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException, EmsDuplicateLocationException {
	...
	private PosicionPersona crearPosicionPersona(String[] data) {
		return new PosicionPersona(new Coordenada(Float.parseFloat(data[4]), Float.parseFloat(data[5])),
				data[1], this.parsearFecha(data[2], data[3]));
	}
